...
All task descriptions in this repository must be Markdown. This applies to parent stories, role subtasks, refinement issues, PR descriptions, and evidence updates.
...
- Avoid unstructured paragraphs as the only task body.
